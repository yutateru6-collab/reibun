...
export const PERFECT_SUMMARY = [
  {
    id: 'perfect-continuation',
    label: '継続',
    form: 'have / has + 過去分詞',
    reference: '過去から今までずっと',
    core: '「ずっと〜している／ずっと〜だ」',
    timeline: '状態動詞：have + 過去分詞 ／ 動作動詞：have been ~ing をよく使う',
    example: 'Mr. and Mrs. Smith have lived in Kyoto since 2020. ／ I have been learning English for seven years.',
  },
  {
    id: 'perfect-experience',
    label: '経験',
    form: 'have / has + 過去分詞',
    reference: '今までの経験',
    core: '「〜したことがある／ない」',
    timeline: 'ever / never / before / once / several times などとよく使う',
    example: 'I have been to Tokyo several times.',
  },
  {
    id: 'perfect-result',
    label: '結果',
    form: 'have / has + 過去分詞',
    reference: '過去の動作 → 今の状態',
    core: '「〜した／してしまった」＋その結果が今に残る',
    timeline: 'just / already / yet などとよく使う',
    example: 'I have just finished reading this book. ／ He has hurt his knee and is in the hospital now.',
  },
] as const;
