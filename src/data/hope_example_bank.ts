...
export const hopeLesson10Cards: Card[] = [
  ...
  { id: 4089, front: "The ratio of robots to humans in this factory is 3 to", translation: "この工場ではロボットと人間の比率は３対２だ。", comment: sourceComment("Hope Example Bank Lesson 10 p.52 No.7"), hint: "", back: "The ratio of robots to humans in this factory is 3 to" },
