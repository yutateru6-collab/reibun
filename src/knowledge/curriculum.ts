...
export const TOPICS: Topic[] = [
  { id: 'overview', title: '時制の全体像', short: '全体像', description: 'まず「何を表す形？」から。', icon: 'compass', numbers: range(1, 12), points: [
    { label: '現在形と進行形', text: 'ふだんの習慣は現在形。\n進行形の基本は「動作の途中」。' },
    { label: '現在完了形', text: '過去と今のつながりを見る。\n継続・経験・完了と結果を表せる。' },
  ...
  { id: 'present', title: '現在形と進行形', short: '現在・進行形', description: '習慣・状態と、動作の途中を区別。', icon: 'clock', numbers: [13, 14, 30, 43, 44, 45, 55, 56, 57, 70, 73, 74, 81], points: [
    { label: '習慣・状態', text: '「毎週する」は今の習慣。\n「知っている」のknowは状態を表し、通常は進行形にしない。' },
    { label: '進行形の作り方', text: 'be動詞＋動詞のing形\n現在：am / is / are\n過去：was / were' },
  ...
  { id: 'past', title: '過去形と過去完了形', short: '過去・過去完了', description: '過去のどの時点から見る？', icon: 'history', numbers: [16, 48, ...range(49, 54), 59, 71, 76], points: [
    ...
    { label: '過去完了形', text: 'had＋過去分詞\n過去のある時点を基準に、それより前のことを見る。' },
    { label: '時間の順番', text: '「到着したとき、映画はすでに始まっていた」\n映画の開始 → 映画館に到着\n映画の開始が先、到着が後。' },
  ] },
  { id: 'perfect', title: '現在完了形', short: '現在完了', description: '「今とのつながり」と３つの意味。', icon: 'link', numbers: [15, ...range(21, 29), 46, 47, 58, 68, 75, 79, 80, 97, 98, 102], points: [
    { label: '基本の形', text: 'have / has＋過去分詞\n過去のことを、今とのつながりから見る。' },
    { label: '３つの意味', text: '継続：ずっと〜している\n経験：〜したことがある\n完了・結果：もう〜した／〜してしまって今…だ\n※訳は代表例。' },
    { label: 'forとsince', text: 'for：期間の長さ（３年間など）\nsince：出発点（2020年以来など）' },
  ] },
  { id: 'continuous', title: '完了進行形', short: '完了進行形', description: '前から、いつまで続いている？', icon: 'repeat', numbers: [19, 20, 67, 69, 78, 82], points: [
    { label: '今まで続く動作', text: 'have / has been＋動詞のing形\n現在完了進行形は、前から今まで続いた動作に注目する。' },
    { label: '過去の時点まで', text: 'had been＋動詞のing形\n過去完了進行形は「バスが来たとき」など、過去の時点までの動作の継続を見る。' },
  ...
  { id: 'future', title: '未来の６タイプ', short: '未来の表現', description: '意志・計画・予定・完了を整理。', icon: 'arrow', numbers: [17, 18, ...range(31, 42), 60, ...range(61, 66), 72, 77, 83, 84], points: [
    { label: 'will / be going to', text: 'will：予測や意志\nbe going to：前からの計画や、今の状況からの予測' },
    { label: '現在形 / 現在進行形', text: '現在形：時刻表などの公的な予定\n現在進行形：準備が進んでいる予定\n教材の代表的な使い方との対応。' },
    { label: '未来進行形 / 未来完了形', text: 'will be＋動詞のing形\n→ 予定の成り行き\nwill have＋過去分詞\n→ 未来の時点までの完了・経験・継続' },
  ] },
  { id: 'expressions', title: '時のルールと関連表現', short: 'ルール・表現', description: '「〜したら」「今にも〜する」など。', icon: 'book', numbers: [...range(85, 96), 99, 100, 101], points: [
    ...
    { label: '未来の関連表現', text: 'be about to＋原形\n→ まさに〜しようとしている\nbe expected to＋原形\n→ 〜すると予測されている' },
    { label: '変化・考えていること', text: 'have / has come to＋原形\n→ 〜するようになってきた\nbe thinking of＋動詞のing形\n→ 〜しようと思っている' },
  ] },
];
